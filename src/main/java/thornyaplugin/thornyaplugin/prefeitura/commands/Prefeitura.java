...
public class Prefeitura implements CommandExecutor {
    ...
    public Prefeitura(ThornyaPlugin main){
        this.pl = main;
    }
    @Override
                            ...
                            if (Objects.requireNonNull(pl.getFileP().getString("votacao.estado")).equalsIgnoreCase("Ativada")) {
                                if (!pl.sqlLeis.hasVoted(p.getName())) {
                                    ...
                                    pl.candidatosVar.candidatos.forEach((candidatoName, aBoolean) -> {
                                        ...
                                        if (pl.candidatosVar.candidatos.size() == 2) {
                                            if (listSize.get() == 1) {
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 3) {
                                            if (listSize.get() == 1) {
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 4) {
                                            if (listSize.get() == 1) {
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 5) {
                                            if (listSize.get() == 1) {
                                                guivote.setItem(3, 2, candidato);
                                            } else if (listSize.get() == 2) {
                                                guivote.setItem(3, 4, candidato);
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 6) {
                                            if (listSize.get() == 1) {
                                                guivote.setItem(3, 2, candidato);
                                            } else if (listSize.get() == 2) {
                                                guivote.setItem(3, 4, candidato);
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 7) {
                                            if (listSize.get() == 1) {
                                                guivote.setItem(3, 2, candidato);
                                            } else if (listSize.get() == 2) {
                                                guivote.setItem(3, 4, candidato);
                                        ...
                                        } else if (pl.candidatosVar.candidatos.size() == 8) {
                                            if (listSize.get() == 1) {
                                                guivote.setItem(3, 2, candidato);
                                            } else if (listSize.get() == 2) {
                                                guivote.setItem(3, 4, candidato);
